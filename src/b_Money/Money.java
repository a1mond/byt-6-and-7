...
public class Money implements Comparable<Money> {
	...
	public Integer universalValue() {
		return this.currency.universalValue(amount);
	}
	...
	public Boolean equals(Money other) {
		return Objects.equals(this.amount, other.amount) &&
				this.currency.getName().equals(other.getCurrency().getName());
	}
	...
	public Money add(Money other) {
		return new Money(
				 amount + currency.valueInThisCurrency(other.amount, other.currency),
				this.currency
		);
	}
	...
	public int compareTo(Money o) {
		if (this.universalValue() > o.universalValue()) return 1;
		else if (this.universalValue() < o.universalValue()) return -1;
		return 0;
	}
}